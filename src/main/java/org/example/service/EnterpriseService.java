...
public class EnterpriseService {
    ...
    public EnterpriseDto getById(String username, Long id) {
    ...
    public Enterprise getEntityById(String username, Long id) {
    ...
    @Transactional
    public EnterpriseDto updateEnterprise(EnterpriseDto enterpriseDto, String username, Long id) {
        Enterprise enterprise = getEntityById(username, id);
